...
This report is a summary of the phenotype data and includes subject-level summary metrics, 
...
`r n.invalid.types.removed` `r if (n.invalid.types.removed == 1) {" subject is "} else {" subjects are "}`
removed for containing more than `r subj.invalid.type.max` datapoints not matching the
