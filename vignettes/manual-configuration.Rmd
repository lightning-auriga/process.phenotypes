...
```{r setup}
library(process.phenotypes, quietly = TRUE)
...
or lower bound, or 2) creating a derived variable with a more sophisticated operation to attempt
...
table_comparisons - takes a yaml sequence of additional variable names and makes contingency tables vs current variable
linked_date
  reported_year
  reference_year
