...
paradigms of configuration. Most notably, it can be difficult to keep similar
...
Shared models most naturally fit categorical models, but are not necessarily required
